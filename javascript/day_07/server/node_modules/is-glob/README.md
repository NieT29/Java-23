...
Also take a look at [is-valid-glob](https://github.com/jonschlinkert/is-valid-glob)
...
* [is-valid-glob](https://www.npmjs.com/package/is-valid-glob): Return true if a value is a valid glob pattern or
  patterns. | [homepage](https://github.com/jonschlinkert/is-valid-glob)
...
requests, [please create an issue](https://github.com/jonschlinkert/is-glob/issues/new).
